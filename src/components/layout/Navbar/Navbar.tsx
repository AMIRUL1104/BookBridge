...
export default function Navbar() {
  ...
  return (
    // ব্যাকগ্রাউন্ড পরিবর্তন করে #2B5748 এবং বর্ডার rgba(255,255,255,0.1) করা হলো
    <header className="sticky top-0 z-50 w-full bg-[#2B5748] border-b border-white/10 shadow-md">
